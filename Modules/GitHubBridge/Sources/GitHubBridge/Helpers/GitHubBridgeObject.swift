...
public protocol GitHubBridgeObject {
	...
	static func mixedRepresentation(from remoteObject: GitHubRemoteDb.RemoteObject, userInfo: GitHubBridgeObjects.UserInfo) throws -> MixedRepresentation<GitHubBridgeObjects>?
